<%@ Page Title="" Language="C#" MasterPageFile="~/pages/Site.Master" AutoEventWireup="true" CodeBehind="UpdateProduct.aspx.cs" Inherits="FinalQuiz.pages.UpdateProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div>
            ...
            <asp:Label ID="errorName" Visible="false" runat="server" Text="Cannot be Empty" style="color:red ; font-style:italic"></asp:Label>
        ...
        <div class="col-12">
            <asp:Button ID="updateProductBtn" CssClass="login_button" runat="server" Text="Update Product" OnClick="updateProductBtn_Click" />
         </div>
